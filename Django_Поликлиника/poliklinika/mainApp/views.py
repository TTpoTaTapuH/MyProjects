...
from .models import Doctor, Medicina, Service
...
def profile_draft(request):
    return render(request, 'profile/profile_draft.html')

def profile_to_priem(request):
    return render(request, 'profile/profile_to_priem.html')

def profile_priems(request):
    return render(request, 'profile/profile_priems.html')

def uslugi_pk(request):
    return HttpResponse('tett')